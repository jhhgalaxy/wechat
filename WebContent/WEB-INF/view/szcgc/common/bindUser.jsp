...
<meta name="description" content="用户手机绑定" />
<meta name="keywords" content="用户手机绑定" />
<title>用户手机绑定</title>
...
$(function(){
	...
	$('#res-btn').on('click',function(){
		...
		jQuery.ajax({
			type: 'POST',
			contentType:"application/x-www-form-urlencoded; charset=utf-8",
			data: {code:yanzheng,phone:mobile,userid:userid,checkType:"bindUser"},
...
<div class="register">
    <div class="binding"><img src="${pageContext.servletContext.contextPath}/resources/images/ico_verification.png" /><p>用户身份绑定</p></div>
	<div class="binding-item">   
		<input type="tel" name="phone" id="phone" placeholder="手机号" class="input-item mobile">
